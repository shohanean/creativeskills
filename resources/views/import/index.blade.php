...
<div class="toolbar" id="kt_toolbar">
    ...
    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
        ...
        <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
            <!--begin::Title-->
            <h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Import
            <!--begin::Separator-->
            ...
            <div class="card-body pt-2">
                ...
                <form method="POST" action="{{ route('import') }}" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-2">
                            <label class="required form-label">Month, Year</label>
                            <!--begin::Input group-->
                            <div class="input-group mb-5">
                                <input type="month" class="form-control" name="month_year" value="{{ \Carbon\Carbon::today()->format('Y-m') }}"/>
                            </div>
                            <!--end::Input group-->
                        </div>
                        @if ($courses->count() != 0)
        ...
        <div class="card card-xl-stretch mb-5 mb-xl-8">
            ...
            <div class="card-header border-0 pt-5">
                <h3 class="card-title align-items-start flex-column">
                    <span class="card-label fw-bolder fs-3 mb-1">Students Records</span>
                    <span class="text-muted mt-1 fw-bold fs-7">Over {{ $students->count() }} students</span>
                </h3>
            </div>
            <!--end::Header-->
            <!--begin::Body-->
                    ...
                    <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
                        ...
                        <thead>
                            <tr class="fw-bolder text-muted">
                                ...
                                <th class="min-w-200px">Coruse Name</th>
                                <th class="min-w-150px">Date</th>
                                <th class="min-w-150px">Course Fee</th>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="symbol symbol-45px me-5">
                                                <img src="{{ Avatar::create($student->student_name)->toBase64() }}" alt="not found"/>
                                            </div>
                                            <div class="d-flex justify-content-start flex-column">
                                                <a href="#" class="text-dark fw-bolder text-hover-primary fs-6">{{ $student->student_name }}</a>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
